 ...
 * distribution.
 */
#ifndef GMAPI_BINSEARCH_HPP
#define GMAPI_BINSEARCH_HPP
namespace gm
{
    struct SearchByte
    {
    ...
    const void *searchMemory(const SearchByte *bytes, unsigned len);
    
    static const SearchByte DELPHI_NEWUTF8_PATTERN[] =
    {
        //Based on 0x407388 in GM 8.1.305
        {0x85,0},{0xC0,0},
        {0x7E,0},{0,1},
        {0x50,0},
    ...
    {
        //Based on 0x004072D8 in GM 8.1.305
        {0x8B,0},{0x10,0},
        {0x85,0},{0xD2,0},
        {0x74,0},{0,1},
