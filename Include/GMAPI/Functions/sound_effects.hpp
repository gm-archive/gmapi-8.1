...
namespace gm
{
    ...
    {
        call(functions[756], snd, wetdry, depth, feedback, frequency, wave, delay, phase);
    }
    
    inline void sound_effect_echo(Real snd, Real wetdry, Real feedback, Real leftdelay, Real rightdelay, Real pandelay)
    {
        call(functions[757], snd, wetdry, feedback, leftdelay, rightdelay, pandelay);
    }
