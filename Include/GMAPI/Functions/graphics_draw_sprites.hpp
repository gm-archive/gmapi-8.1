...
namespace gm
{
    ...
    {
        call(functions[415], sprite, subimg, left, top, width, height, x, y, xscale, yscale, color, alpha);
    }
    ...
    {
        call(functions[416], sprite, subimg, left, top, width, height, x, y, xscale, yscale, rot, c1, c2, c3, c4, alpha);
    }
