...
namespace gm
{
    ...
    {
        call(functions[660], ind, bind, vis, fore, back, x, y, htiled, vtiled, hspeed, vspeed, alpha);
    }
    ...
    {
        call(functions[669], ind, back, left, top, width, height, x, y, depth, xscale, yscale, alpha);
    }
